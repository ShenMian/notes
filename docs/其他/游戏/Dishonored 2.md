...
- 守卫(Grand Guard): 武器可能只有剑, 可能也有枪.
- 发条战士(Clockwork soldiers): 前后方都有视野, 无法被暗杀.
  但可以利用背后的弱点结合刀枪秒杀.
- 女巫(Witch): 有超能力, 包括瞬移/远程攻击. 一旦开战比较难对付.
- 狼狗(Wolfhound): 有嗅觉, 在一定范围内会被感知到. 血量低.
- 墓地猎犬(Gravehound): 以头骨形式存在时可以通过远超攻击或投掷销毁, 会爆炸并发出响声.
...
- 骨牌(艾米莉): 可以将作用在一个敌人的效果映射到多个敌人. 可以节约弹药/同时消灭多个敌人.
