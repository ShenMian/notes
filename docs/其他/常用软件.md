...
| 名称                       | 描述                      | 包名                             |
| -------------------------- | ------------------------- | -------------------------------- |
| [Visual Studio Code]       | 轻量 IDE, 开源.           | `visual-studio-code-bin`(pacman) |
...
| 名称   | 描述                                               | 包名                 |
| ------ | -------------------------------------------------- | -------------------- |
| [exa]  | ls 命令替代, 更丰富的色彩, 快速, 开源, 即将跨平台. | `exa`(pacman/scoop)  |
| [bat]  | cat 命令替代, 代码高亮, 集成 Git.                  | `bat`(pacman/scoop)  |
| [btop] | top 命令替代, 美观的界面, 缺少 GPU 信息, 跨平台.   | `btop`(pacman/scoop) |
| [lf]   | 文件管理器.                                        | `lf`(scoop)          |
| [glow] | Markdown 预览.                                     | `glow`(pacman/scoop) |
