...
掌握 Vim 并不需要刻意记忆命令, 经常使用即可. [vimtutor](https://github.com/vim/vim/tree/master/runtime/tutor) 提供了一个交互式的入门教学, 时长约 30 min.
...
![Vi/Vim 速查表 - www.viemu.com](assets/vi_vim_cheat_sheet.webp){ align=right width=60% }  
