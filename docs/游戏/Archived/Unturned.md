...
![封面 - Smartly Dressed Games](assets/unturned_cover.webp){ width=30% style="display: block; margin: 0 auto" }  
...
目前该做已停止新特性的开发, 进入了长期维护状态. 新作 Unturned II 的开发也已被永久暂停.
...
| 148  | Red Chevron Scope          | 红 V 字瞄准镜    |
| 153  | 7x Scope                   | 7 倍瞄准镜      |
| 296  | 16x Scope                  | 16 倍瞄准镜     |
