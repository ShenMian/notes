...
| Bitwarden ([社区 (Rust)]/[官方 (C#)]) | 密码管理器                    | AGPL-3.0   | P2PE[^p2pe] |
| [Gitea]                               | Git 托管平台, 功能类似 GitHub | MIT        |             |
| [Wakapi]                              | 编码统计                      | MIT        |             |
| [Ente Photos]                         | 照片/视频云盘                 | AGPL-3.0   | P2PE        |
| [CryptPad]                            | 云盘                          | AGPL-3.0   | P2PE        |
| [Synapse]                             | Matrix 服务器                 | AGPL-3.0   | P2PE        |
...
[Ente Photos]: https://github.com/ente/ente
[CryptPad]: https://github.com/cryptpad/cryptpad

[^p2pe]: 端到端加密 (Peer-to-Peer Encryption, P2PE).
