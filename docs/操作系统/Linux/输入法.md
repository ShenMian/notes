...
![效果图](assets/fcitx5_theme_mint.webp){ width=70% }  
...
wget https://github.com/felixonmars/fcitx5-pinyin-zhwiki/releases/download/0.3.0/zhwiki-20260416.dict -O ~/.local/share/fcitx5/pinyin/dictionaries/zhwiki.dict
```

## 参见

- [Fcitx 5 -  Arch Linux 中文维基](https://wiki.archlinuxcn.org/wiki/Fcitx_5).
