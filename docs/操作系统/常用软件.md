...
| [kiwix-js-windows] | ZIM 阅读器, Linux/Windows 平台, 开源. |                          |
...
| [exa]      | ls 命令替代, 更丰富的色彩, 快速, 开源, 不官方支持 Windows. :crab: | `exa`(pacman)            |
...
- [Clash Verge](https://github.com/zzzgydi/clash-verge), 开源.
- [Clash for Android](https://github.com/Kr328/ClashForAndroid), 开源.
